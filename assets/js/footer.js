/**
 * Common Footer for M&O Marine Service
 */
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
                <div class="lg:col-span-2 pr-0 lg:pr-12">
                    <a href="./" class="flex items-center gap-5 mb-6 group cursor-pointer w-max" aria-label="M&O Marine Service home">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="services.html" class="text-navy-300 hover:text-white transition-colors text-sm">Ship Provisions & Bonded</a></li>
                        <li><a href="technical.html" class="text-navy-300 hover:text-white transition-colors text-sm">Technical Spares</a></li>
                        <li><a href="technical.html" class="text-navy-300 hover:text-white transition-colors text-sm">Safety & Lifesaving (FFA/LSA)</a></li>
                        <li><a href="logistics.html" class="text-navy-300 hover:text-white transition-colors text-sm">Port Logistics & Clearance</a></li>
                        <li><a href="services.html" class="text-navy-300 hover:text-white transition-colors text-sm">Nautical Charts & Publications</a></li>
                        <li><a href="contact.html" class="text-navy-300 hover:text-white transition-colors text-sm">Port Agency Services</a></li>
                    </ul>
                </div>
