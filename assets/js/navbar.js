/**
 * Common Navbar for M&O Marine Service
 * Simplified for flattened directory structure
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    <header class="fixed top-0 w-full z-50 glass-nav transition-all duration-300" id="navbar">
        <div class="max-w-7xl mx-auto px-6 h-28 flex items-center justify-between">
            <a href="./" class="flex items-center gap-4 group relative cursor-pointer" aria-label="M&O Marine Service home">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute top-[calc(100%+0.5rem)] -left-4 w-[280px] bg-navy-950/95 backdrop-blur-xl border border-white/10 rounded-lg shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible group-focus-within:opacity-100 group-focus-within:visible transition-all duration-300 transform origin-top -translate-y-2 group-hover:translate-y-0 group-focus-within:translate-y-0">
                        <div class="p-2 flex flex-col gap-1">
                            <a href="assets/pdf/M_O_Monthly_Publications_Check_List_for_Med_Black_Red_Sea.pdf" target="_blank" class="flex items-start gap-3 px-4 py-3 text-sm text-white/70 hover:text-white hover:bg-white/10 rounded-md transition-colors group/item">
                            ...
                            <a href="assets/pdf/M_O_Publications_Index_Worldwide_Coverage.pdf" target="_blank" class="flex items-start gap-3 px-4 py-3 text-sm text-white/70 hover:text-white hover:bg-white/10 rounded-md transition-colors group/item">
                                <span class="material-symbols-outlined text-[20px] text-maritime-500 group-hover/item:text-white transition-colors">picture_as_pdf</span>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-navy-950/95 backdrop-blur-xl border-t border-white/10 absolute top-full left-0 w-full shadow-2xl max-h-[calc(100vh-112px)] overflow-y-auto">
            <div class="px-6 py-6 flex flex-col gap-4">
                <a href="./" class="text-white/70 hover:text-white text-lg font-medium border-b border-white/10 pb-3 transition-colors">Home</a>
                <a href="about.html" class="text-white/70 hover:text-white text-lg font-medium border-b border-white/10 pb-3 transition-colors">About</a>
                <a href="services.html" class="text-white/70 hover:text-white text-lg font-medium border-b border-white/10 pb-3 transition-colors">Services</a>
                <a href="faq.html" class="text-white/70 hover:text-white text-lg font-medium border-b border-white/10 pb-3 transition-colors">FAQ</a>
                <a href="contact.html" class="text-white/70 hover:text-white text-lg font-medium border-b border-white/10 pb-3 transition-colors">Contact</a>
                <div class="border-b border-white/10 pb-3">
                    ...
                    <div id="mobile-pubs" class="hidden flex-col gap-4 mt-4 pl-4 border-l-2 border-maritime-500/30">
                        <a href="assets/pdf/M_O_Monthly_Publications_Check_List_for_Med_Black_Red_Sea.pdf" target="_blank" class="flex items-start gap-3 text-white/60 hover:text-white transition-colors">
                        ...
                        <a href="assets/pdf/M_O_Publications_Index_Worldwide_Coverage.pdf" target="_blank" class="flex items-start gap-3 text-white/60 hover:text-white transition-colors">
                            <span class="material-symbols-outlined text-[20px] text-maritime-500 mt-0.5">picture_as_pdf</span>
    ...
    handleScroll(); // Trigger immediately to prevent jump on refresh if already scrolled
});
